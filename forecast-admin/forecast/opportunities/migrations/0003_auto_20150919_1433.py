...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('opportunities', '0002_award_owner'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='award',
            name='contract_type',
            field=models.CharField(blank=True, verbose_name='Contract Type', choices=[('Fixed Price with Economic Price Adjustment', 'Fixed Price with Economic Price Adjustment'), ('Fixed Price Incentive', 'Fixed Price Incentive'), ('Fixed Price Award Fee', 'Fixed Price Award Fee'), ('Cost Plus Award Fee', 'Cost Plus Award Fee'), ('Cost No Fee', 'Cost No Fee'), ('Cost Sharing', 'Cost Sharing'), ('Cost Plus Fixed Fee', 'Cost Plus Fixed Fee'), ('Cost Plus Incentive Fee', 'Cost Plus Incentive Fee'), ('Time and Materials', 'Time and Materials'), ('Labor Hours', 'Labor Hours'), ('Order Dependent', 'Order Dependent'), ('To Be Determined', 'To Be Determined'), ('Interagency Agreement', 'Interagency Agreement')], max_length=200, null=True),
        ),
        migrations.AddField(
            model_name='award',
            name='published',
