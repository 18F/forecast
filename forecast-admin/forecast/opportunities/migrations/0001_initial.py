    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimated_fiscal_year', models.IntegerField(blank=True, null=True, max_length=200)),
                ('estimated_fiscal_year_quarter', models.IntegerField(blank=True, null=True, max_length=200)),
